...
document.addEventListener("DOMContentLoaded", () => {
  ...
  modeChangeBtn.addEventListener("click", function () {
    ...
    if (!state) {
      ...
      document.querySelector(".main_contents_sonny").style.backgroundColor =
        "#202b38";
      ...
      for (let i = 0; i < projectInfo.length; i++) {
        ...
        projectInfo[i].style.boxShadow =
          "rgba(0, 0, 0, 0.4) 0px 2px 3px, rgba(0, 0, 0, 0.3) 0px 7px 10px -2px, rgba(0, 0, 0, 0.2) 0px -1px 0px inset";
      }
...
$(function () {
  ...
  $(".follow_menu").css(
    "top",
    $(window).height() / 2 - $(".follow_menu").height() / 2
  );
...
const planning4 = $(
  ".no_project04 > .project02_info > #contribute > #planning > span"
);
const design4 = $(
  ".no_project04 > .project02_info > #contribute > #design > span"
);
...
document.addEventListener("DOMContentLoaded", () => {
  const modal01Open = document.querySelector(
    ".no_project01 > .project01> .page_nav .modal"
  );
  const modal02Open = document.querySelector(
    ".no_project02 > .project02> .page_nav .modal"
  );
  ...
  for (let i = 0; i < mobilebtn.length; i++) {
    mobilebtn[i].addEventListener("click", function () {
      window.open(
        ...
        "_blank",
        "menubar=no, resizable=yes, toolbar=no, location=no, status=no, width=390,height=844,top=150,left=750"
      );
    });
  }
});
